  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: useMotionTemplate`radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px, ${gradientFrom}, ${gradientTo}, var(--color-base-100) 100%)`
        }}
      />
      <div className="absolute inset-px rounded-[inherit] bg-base-100 dark:bg-base-200" />
      <motion.div
